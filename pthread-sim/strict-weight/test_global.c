...
void test_mheap_wakeup_lag() {
	...
	printf("all running"); print(gh, gs, GRP3);

	dequeue(gh, c, p0, tl);
	printf("deq 0"); print(gh, gs, GRP3);
	dequeue(gh, c, p1, tl);
	dequeue(gh, c, p2, tl);

	printf("deq all"); print(gh, gs, GRP3);

	enqueue(gh, c, p1);

	printf("enq 1"); print(gh, gs, GRP3);

	enqueue(gh, c, p2);

	printf("enq 2"); print(gh, gs, GRP3);
