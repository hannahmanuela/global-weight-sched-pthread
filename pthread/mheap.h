...
struct heap_elem *mh_deq_min_elem(struct mheap *mh, int hint, is_lt_elem_t is_ltf);
struct heap_elem *mh_deq_min_elem_enq(struct mheap *mh, struct heap_elem *p, int hint, is_lt_elem_t is_ltf);
struct heap_elem *mh_deq_min_elem_all_heap(struct mheap *mh, is_min_elem_t minf);
